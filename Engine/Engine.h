...
//------------------------------------------------------------------------------
  ...
  private: // Functions
    ...
    LAYER* NewLayer (const char* Filename, bool ConvertStrokesToFills);
    LAYER* FindLayer(const char* Filename, bool ConvertStrokesToFills);
    ...
    void AddText(pdfContents* Contents, pdfPage* Page);
//------------------------------------------------------------------------------
